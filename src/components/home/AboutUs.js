        ...
        <Row className="row-gap-5">
          ...
          <Col lg={7}>
            <div className="ms-lg-5">
              ...
              <p className="mt-4">
                Embark on the path to a more secure and confident future with Risk
                IQ insurance. Our insurance solutions are built on a foundation of
                trust, reliability, and a commitment to your well-being. Explore
                our offerings, and let us be your guide in navigating life’s
